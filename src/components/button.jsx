...
export default function Button({ href, children, onClick, userID }) {

    const fullHref = userID ? `${href}?userID=${encodeURIComponent(userID)}` : href;

    return (
        <Link href={fullHref} onClick={onClick}> {/* Use fullHref here */}
